            ...
            <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <p className="mt-1 text-sm leading-6 text-gray-600">
                        This information will be used to generate your API. To
                        help us generate your API, please fill out the form
                        below.
                    </p>
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="col-span-full">
                            ...
                            <p className="mt-1 text-sm leading-6 text-gray-600">
                                This will be the <b>routes</b> and for your
                                service. e.g. books, users will be <b>/books</b>{' '}
                                and <b>/users</b>. Also <b>models</b> will be
                                created with the same name.
                            </p>

                            {Array.from({ length: routesCount }).map((_, i) => {
                                return (
                                    <div
